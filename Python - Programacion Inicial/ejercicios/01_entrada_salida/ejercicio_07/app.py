...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        ...
        sumar = str(valor_a + valor_b)
        alert("titulo", "la suma es: " + sumar)

    def btn_restar_on_click(self):
        valor_a = int(self.txt_operador_a.get())
        valor_b = int(self.txt_operador_b.get())
        restar = str(valor_a - valor_b)
        alert("titulo", "la resta es: " + restar)

    def btn_multiplicar_on_click(self):
        valor_a = int(self.txt_operador_a.get())
        valor_b = int(self.txt_operador_b.get())
        multiplicar = str(valor_a * valor_b)
        alert("titulo", "la multiplicacion es: " + multiplicar)

    def btn_dividir_on_click(self):
        valor_a = int(self.txt_operador_a.get())
        valor_b = int(self.txt_operador_b.get())
        dividir = int(valor_a / valor_b)
        alert("titulo", f"la division es: {dividir:.0f}")
