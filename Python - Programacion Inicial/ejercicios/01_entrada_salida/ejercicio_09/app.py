...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        resultado = float(sueldo + sueldo * incremento/100)
        alert("Sistema de incremento", f"el sueldo es de {sueldo}, el incremento corresponde a %{incremento} y el sueldo final es: {resultado:.2f}")
